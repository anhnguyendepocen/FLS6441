...
data%>%
  mutate(Info_Proposition=as.numeric(Info_Proposition)) %>%
 zelig(Info_Proposition ~ Watched_Program,
                     data = ., model = "normal",cite = F) %>%
  from_zelig_model()%>%
  stargazer(keep = c("Constant","Watched_Program"))
```
